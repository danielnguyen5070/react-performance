import { useState, use, useTransition, Suspense, memo } from 'react'
...
const CityItem = memo(function ({ city, index, isHighlighted, isSelected, getItemProps }: { city: CityProps, index: number, isHighlighted: boolean, isSelected: boolean, getItemProps: UseComboboxPropGetters<CityProps>['getItemProps'] }) {
    return (
        <li
            key={city.id}
            {...getItemProps({
